...
public final class STTabbar: UITabBar {
    ...
    private func addShape() {
        ...
        let colorTop =  UIColor(red: 40.0/255.0, green: 52.0/255.0, blue: 66.0/255.0, alpha: 1.0).cgColor
        let colorBottom = UIColor(red: 19.0/255.0, green: 26.0/255.0, blue: 34.0/255.0, alpha: 1.0).cgColor
    ...
    private func setupMiddleButton() {
        ...
        centerButton.titleLabel?.font = UIFont(name: "Courier", size: 50)
        //centerButton.titleLabel?.font = centerButton.titleLabel?.font.withSize(40)
        centerButton.titleEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: -8, right: -2)
    ...
    private func setupMiddleLabel() {
        let centerLabel = UILabel(frame: CGRect(x: (self.bounds.width / 2)-(centerButtonHeight/2), y: 50, width: centerButtonHeight, height: centerButtonHeight))
        
        centerLabel.layer.cornerRadius = centerLabel.frame.size.width / 2.0
        //centerLabel.setTitle(buttonTitle, for: .normal)
        //centerLabel.setImage(buttonImage, for: .normal)
        centerLabel.text = "İLAN VER"
        centerLabel.font = UIFont(name: "HelveticaNeue-Thin", size: 12)
        //centerLabel.backgroundColor = centerButtonColor
        centerLabel.tintColor = UIColor.gray
